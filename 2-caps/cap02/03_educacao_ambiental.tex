...
Outro exemplo são os projetos de captação de água de uma escola no DF (figura~\ref{fig:captacao-agua-brasilia}) que foram alavancadas pela a pior crise hídrica da história da capital, com 513 dias de racionamento de água (conforme \citeaa{G120190322Daumildo}).

\href{https://www.youtube.com/watch?v=gNHgCbPgL40}{
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{fig/Captacao-Agua-Brasilia}
        \caption[Escola do DF desenvolve projetos sustentáveis]{Escola do DF desenvolve projetos sustentáveis, disponível em \url{https://www.youtube.com/watch?v=gNHgCbPgL40}}
