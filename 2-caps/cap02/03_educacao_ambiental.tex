...
Outro exemplo são os projetos de captação de água de uma escola no DF (figura~\ref{fig:captacao-agua-brasilia}) que foram alavancadas pela a pior crise hídrica da história da capital \citeaa{G120190322Daumildo}.
