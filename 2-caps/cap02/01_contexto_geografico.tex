...
A população brasiliense é formada por migrantes de todas as regiões brasileiras, sobretudo do Nordeste e do Sudeste, além de estrangeiros que trabalham nas embaixadas espalhadas pela capital. Dados de 2010 apontavam que quase metade da população não nasceu ali, sendo que 1 380 873 (53,73\%) eram brasilienses e 1 189 287 (46,27\%) de outros locais (incluindo 8 577 estrangeiros, ou 0,33\% da população), principalmente de Goiás, Minas Gerais e Bahia, conforme o quadro abaixo.

\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{fig/migrantes-1959-2010}
    \caption[Quadro comparativo de migrantes em brasília \citeaa{CODEPLANSEPLAN2013} ]{}
